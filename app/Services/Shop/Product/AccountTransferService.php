...
class AccountTransferService extends ProductService implements ProductInterface{
    ...
    public function add($data)
    {
        ...
        try{
            ...
            $result = curlApi(env('API_URL').'/product/create_product_transfer_cashcard',$data); 
        } catch (Exception $e){
         DB::rollBack();
