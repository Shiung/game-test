...
class RegisterCardService extends ProductService implements ProductInterface{

    protected $productMemberLevelRepository;
    /**
     * RegisterCardService constructor.
     *
    ...
    public function useProduct($product_id, $quantity, $paramenters = [])
    {
        ...
        try{
            $data= [
                ...
                'quantity' => $quantity,
                'username' => $paramenters['username'], 
                'password' => bcrypt($paramenters['password']),
                'name'=> $paramenters['name'],
                'parent_id' => $paramenters['parent_id'],
                'position' => $paramenters['position']
            ];
