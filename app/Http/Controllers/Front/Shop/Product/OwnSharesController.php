...
class OwnSharesController extends Controller
{
	...
	public function __construct(
        OwnShareService $productService,
     ...
     * @return view front/shop/product/own_share/use_index.blade.php
     */
    public function useIndex($product_id = null)
    {
    	...
    	$data=[
            ...
            'own_share_amount' => $accounts->where('type','5')->first()->amount,
    ...
    {   
        ...
        $data =[
            'share' => $this->user->member->accounts->where('type','5')->first()->amount,
            'data' => $item,
