...
class CashAccountsController extends Controller
{
    ...
    protected $page_title = '金幣增減';
    protected $menu_title = '金幣增減';
    protected $route_code = 'cash_account';
    protected $view_data = [];
    ...
    public function summary($start = null, $end = null, $period_type = 'd')
    {
    	...
    	$result = $this->statisticService->getStatByRange($start,$end,'account_1',$period_type); 
        $data =[
            'datas' => $result['datas'],
    ...
    public function members($start, $end)
    {
        ...
        $result = $this->statisticService->getMemberStatByRange($start,$end,'account_1'); 
    ...
    public function detail($user_id, $start, $end)
    {
        ...
        $datas = $this->accountRecordService->allByAccountType($account->id,'%',$start,$end); 
        $data =[
            'datas' => $datas,
            'start' => $start,
            'end' => $end,
