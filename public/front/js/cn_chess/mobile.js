...
$(".chip").click(function(){
    ...
    $('#bet_chip .m-bet-bg').addClass('display');
    $('#bet_chip .m-bet-select').removeClass('display');
	chip = $(this).data('type');
    $(this).addClass('circle_active'+chip);
    $(this).removeClass('circle');
    $(this).children('.m-bet-select').addClass('display');
    $(this).children('.m-bet-bg').removeClass('display');
});
...
$(".investment").click(function(){
    ...
    $('#bet_investment .m-bet-bg').addClass('display');
    $('#bet_investment .m-bet-select').removeClass('display');
