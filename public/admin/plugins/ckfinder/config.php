...
//$baseUrl = 'http://61.216.139.151/direct_selling/public/upload/editor/';
$baseUrl = env('UPLOAD_URL').'/editor/';
//获取客户端IP
...
{
	//访问合法性验证
	//允许测试IP 127.0.0.1 及 192.168.0.1 - 192.168.255.255
	//正式发布仅允许 $_SESSION['allowCKFinder'] 为True
	$ipLong = bindec(decbin(ip2long(getClientIP())));
	if($ipLong === 2130706433){
		return true;
	}
	if($ipLong >= 3232235521 || $ipLong <= 3232301055){
		return true;
	}
	if($_SESSION['allowCKFinder'] === TRUE){
		return true;
	}
	return false;
}*/
...
$config['LicenseName'] = '3123123123';
$config['LicenseKey'] = '1231231';
...
*/
//$baseUrl = 'http://140.117.69.55/dephasia/fasong/photo/case/'.$_SESSION["loginMember"].'/';
//$baseUrl = 'http://localhost/shine/upload/editor/';
