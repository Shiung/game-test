...
@else
<a href="{{ route('front.member.transfer_ownership_record.index') }}" class="btn btn-info">重新填寫</a>
{{ $error }}
@endif
    ...
    $(document).ready(function() {
        ...
        $("#Form").validate({
            ...
            submitHandler: function(form) {
                $.ajax({
                    url: APP_URL + "/member/transfer_ownership_record",
                    data: $('#Form').serialize(),
                    type: "POST",
                    success: function(msg) {
                        ...
                        if (data.result == 1) {
                            ...
                            function() {
                                window.location.href = "{{ route('front.member.transfer_ownership_record.index') }}";
                            });
                        } else {
