...
<hr>
<form id="Form" method="POST" action="{{ route('front.bet_record.detail') }}">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <fieldset class="form-group" id="username_field" style="display:none;">
                <input type="text" class="form-control" name="username" id="username" maxlength="50" placeholder="請輸入會員帳號">
            </fieldset>  
        </div>
    </div>   
