...
<div class="bet-page">
    ...
    <form id="Form_bet">
        ...
        <div id="bet_info">
            ...
            <div classs="row">
                <div class="col-xs-6" style="text-align:right; height:50px; line-height:50px;">下注 <span style="color:#094f97 ; font-size:28px; line-height:50px; font-weight:bold;" class="bet_name">{{  $gamblename  }}</span></div>
                <div class="col-xs-6" style="height:50px; line-height:50px;">賠率 <span style="color:#094f97 ; font-size:28px; line-height:50px; font-weight:bold;">{{  $line }}</span></div>
            </div>
            <div class="row">
                <label for="win_amount" class="col-xs-3 control-label" style="padding-right:0; padding-left:0; line-height:35px; text-align:right;">可贏金額</label>
                <div class="col-xs-9">
            ...
            <div class="row">
                <div class="col-xs-12" style="text-align:center; color:#57585b; border-top:2px solid #57585b; border-bottom:2px solid #57585b; padding:5px 0px;">
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-xs-6" style="padding-left:0; padding-right:0; height:115px;">
                <div class="bet-input-area">
                    <div class="bet-gold">{{  number_format($account_amount['cash'])  }}
                    </div>
            ...
            <div class="col-xs-6" style="padding-left:0; padding-right:0; height:115px;">
                <div class="bet-input-area">
                    <div class="bet-ulg">{{ number_format($account_amount['right']) }}
                    </div>
        ...
        <div class="row" style="margin-top:5px;">
            <div class="col-xs-6" style="padding-left:0; padding-right:0; height:115px;">
                <div class="bet-input-area">
                    <div class="bet-red">{{ number_format($account_amount['interest']) }}
                    </div>
            ...
            <div class="col-xs-6" style="padding-left:0; padding-right:0; height:115px;">
                <div class="bet-input-area">
                    <div class="bet-gift">{{  number_format($account_amount['run']) }}
                    </div>
    ...
    $(document).ready(function() {
        ...
        $("#Form_bet").validate({
            ...
            submitHandler: function(form) {
                ...
                //下注成功表頭資訊（隊伍資料等等）
                game_info = '<div class="row" style="width:90%; margin-left:5%; border-top:1px solid #57585b; border-bottom:1px solid #57585b;"><div class="col-xs-12" style="text-align:center; border-top:1px solid #57585b; padding-top:5px;">'+away_team+'</div><div class="col-xs-12" style="text-align:center; padding-bottom:5px;">'+home_team+'</div></div>';
                swal({
                    title: '下注確認',
                    text:'<div class="row" style="width:90%; margin-left:5%; border-top:1px solid #57585b; border-bottom:1px solid #57585b;"><div class="col-xs-6" style="text-align:right; height:50px; line-height:50px;">下注 <span style="color:#094f97 ; font-size:28px; line-height:50px; font-weight:bold;" class="bet_name">{{  $gamblename  }} </span></div><div class="col-xs-6" style="height:50px; line-height:50px; text-align:left; ">賠率 <span style="color:#094f97 ; font-size:28px; line-height:50px; font-weight:bold;">{{  $line }}</span></div><div class="col-xs-12" style="text-align:center; border-top:1px solid #57585b; padding-top:5px;">'+away_team+'</div><div class="col-xs-12" style="text-align:center; padding-bottom:5px;">'+home_team+'</div></div>'+'<table style="width:90%; margin-left:5%; margin-top:10px;"><tr><td style="width:50%;"><div class="sweet-gold" style="line-height: 45px;">'+numeral($('#virtual_cash_amount').val()).format('0,0')+'</div></td><td style="width:50%;"><div class="sweet-ulg" style="line-height: 45px;">'+numeral($('#share_amount').val()).format('0,0')+'</div></td></tr><tr><td style="width:50%;"><div class="sweet-red" style="line-height: 45px;">'+numeral($('#interest_amount').val()).format('0,0')+'</div></td><td style="width:50%;"><div class="sweet-gift" style="line-height: 45px;">'+numeral($('#manage_amount').val()).format('0,0')+'</div></td></tr></table>',
                    type: 'warning',
                    html:true,
