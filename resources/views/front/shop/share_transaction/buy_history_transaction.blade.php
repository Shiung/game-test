...
<div class="container">
    <div class="traction-top-btn-area">
        ...
        <a href="{{ route('front.shop.share_transaction.on_the_shelf') }}"><div class="right-page-btn">上架資訊</div></a>
        <a href="{{ route('front.shop.share_transaction.buy_history') }}"><div class="current-page-btn">購買紀錄</div></a>
    </div>
    ...
    <div class="share-table-area">
        ...
        <table id="buy_list" class="table">
            <thead>
                ...
                <th nowrap="nowrap" style="white-space:nowrap;">建立時間</th>
            </thead>
            <tbody>
            @foreach($buy_transactions as $buy_data)
                <tr>
                    <td style="border-right: 1.5px solid #B6B7B9;">{{ number_format($buy_data->quantity) }}</td>
                    <td style="border-right: 1.5px solid #B6B7B9;">{{ $buy_data->price }}</td>
                    <td>{{ $buy_data->deal_at }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
