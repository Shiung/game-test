    ...
    <div class="row">
        <div class="col-md-4">
            <fieldset class="form-group">
                <label for="quantity">目前專屬娛樂幣餘額</label>
                <input type="number" class="form-control" id="current_own_share_amount" value="{{ $own_share_amount }}" readonly >
            </fieldset>
        </div>
        <div class="col-md-4">
            <fieldset class="form-group">
                <label for="quantity">使用後專屬娛樂幣餘額</label>
                <input type="number" class="form-control" id="new_own_share_amount" value="" readonly >
            </fieldset>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <fieldset class="form-group">
                ...
                <input type="number" class="form-control" id="current_share_amount"  value="{{ $share_amount }}" readonly >
            </fieldset>
        </div>
        <div class="col-md-4">
            <fieldset class="form-group">
                <label for="quantity">使用後娛樂幣餘額</label>
                <input type="number" class="form-control" id="new_share_amount"  value="" readonly >
            </fieldset>
...
<script>
    $(document).ready(function() {
        ...
        var current_share_amount = $('#current_share_amount').val();
        var current_own_share_amount = $('#current_own_share_amount').val();
        refreshShareAmount()
        ...
        function refreshShareAmount(){
            $('#new_share_amount').val(parseInt(current_share_amount)+parseInt($('#quantity').val()) )
            $('#new_own_share_amount').val(parseInt(current_own_share_amount)-parseInt($('#quantity').val()) )
        }
