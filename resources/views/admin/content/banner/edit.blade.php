...
<div class="box-header with-border">
    <ol class="breadcrumb">
        <li>{{ $page_title }}</li>
        <li class="active">瀏覽編輯-{{ $data->name }}</li>
    </ol>
    <!-- 上一頁 -->
    <div class="text-left">
    ...
    <form id="Form">
        <fieldset class="form-group">
          ...
          <div class="input-group">
            <input type="text" class="form-control" name="filepath" value="{{ $data->filepath }}" id="image" readonly required>
        ...
        <!-- 圖片預覽 -->
        <img src="{{ env('UPLOAD_URL').$data->filepath }}" width="100" id="img">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <fieldset class="form-group">
                    ...
                    <input type="url" class="form-control" name="url" id="url" value="{{ $data->url }}" placeholder="ex http://www.google.com">
                </fieldset>
            </div>
        </div>
