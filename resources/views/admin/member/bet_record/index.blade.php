...
<div class="box-body" >
    ...
    <a href="{{ route('admin.member.bet_record.search') }}" class="btn btn-info ">重新搜尋</a>
    ...
    <table id="data_list" class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('admin.member.show',$data['member_id']) }}" class="fancybox fancybox.iframe">{{ $data['name'] }} （{{ $data['username'] }}）</a>
            </td>
