...
<div class="ui inverted segment">
    <div class="ui container" style="text-align:center; padding:60px 0px;">
        <h1 style="color:white">@lang('default.place.active_place_member')</h1>
        <div class="ui large breadcrumb">
          <a href="{{ route('member.dashboard.index') }}" class="section">@lang('default.index')</a>
          <div class="divider"> / </div>
          <a href="{{ route('member.active_user.index') }}" class="section">@lang('default.menu.active_member')</a>
          <div class="divider"> / </div>
          <a class="section">@lang('default.place.active_place_member')</a>
        </div>    
    </div>
</div>
...
<div class="ui container">
    ...
    <div class="ui stackable three column grid">
        <div class="computer tablet only two wide column"></div>
        <div class="twelve wide column">
            <a class="fancybox fancybox.iframe" href="{{ route('member.quick_place.index',$record->id) }}"><button class="ui fluid large vk button">@lang('default.place.quick_place')</button></a>
        </div>
        <div class="computer tablet only two wide column"></div>
    </div>
    <!--/快速搜尋-->
            ...
            success:function(msg){  
              ...
              {  
                swal({   
                  ...
                  function(){
                    window.location.href = APP_URL+"/user/active";
                });
              }
              else
              {
