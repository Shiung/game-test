    ...
    <div class="table-responsive">
        <table id="data_list" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><a href="{{ route('admin.member.show',$data->member_id) }}" class="fancybox fancybox.iframe">{{ $data->old_name }} </a></td>
                    <td>{{ $data->name }}</td>
                    <td>{{ $data->username }}</td>
                    ...
                    <td>
                        @if($data->status == 0)
                            <button type="button" class="btn btn-success btn-sm confirm" data-id="{{ $data->id }}" data-name="{{ $data->old_name }}" >確認</button>
                            <button type="button" class="btn btn-danger btn-sm reject" data-id="{{ $data->id }}" data-name="{{ $data->old_name }}" >拒絕</button>
