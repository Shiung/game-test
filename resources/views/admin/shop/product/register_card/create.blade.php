...
<div class="box-body" >
    <p style="color:red">注意：推薦卡(一般會員)須設定無限期，避免期限到期，會員失去原始等級</p>
    <form id="Form">
        <div class="row">
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <fieldset class="form-group"  style="display:none;">
                    ...
                    <input type="number" class="form-control" name="recommender_feedback" id="recommender_feedback" min="0" value="0" required>
                </fieldset>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                <fieldset class="form-group" >
                    ...
                    <input type="number" class="form-control" name="period" id="period" min="0"  required readonly value="0">
                </fieldset>
            </div>
            <div class="col-md-4">
                <fieldset class="form-group" >
