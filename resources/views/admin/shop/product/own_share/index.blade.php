    ...
    <div class="modal-content">
        <form id="Form">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">編輯專屬權利碼商品</h5>
            </div>
            <div class="modal-body">
                ...
                <fieldset class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" id="price" value="{{ round($data->price) }}" required>
                </fieldset>
                <fieldset class="form-group">
        ...
        table.on("change", ".status :input", function(e) {
            ...
            $.confirm({
                ...
                confirm: function(button) {
                    ...
                    sendUri = APP_URL + "/shop/product/share/change-status/" + id;
