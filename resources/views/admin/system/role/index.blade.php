...
@section('content')
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="{{ route('dashboard.role.index') }}">會員身份列表</a></li>
          </ol>
					<div class="text-right"> 
						<a  href="{{ route('dashboard.role.create') }}"><button class="btn btn-primary btn-sm" data-toggle="tooltip" title="新增"><i class="fa fa-fw fa-plus"></i></button></a>
					</div>    
				</div>
				...
				<div class="box-body">
                    ...
                    <tr>
                        ...
                        <td>{{ $data->name }}</td>
    						        <td>
                          <a href="{{ route('dashboard.role.edit',$data->id) }}"><button class="btn btn-info btn-sm"  data-toggle="tooltip" title="編輯" ><i class="fa fa-pencil-square-o"></i></button>
    ...
    table.on("click",".delete", function(e){
      ...
      $.confirm({
        ...
        confirm: function(button) {
          $.ajax({
            url:"/laravel/public/dashboard/roles/"+id,
